...
var _excluded = ["eventKey", "className", "style", "tabIndex", "dragOver", "dragOverGapTop", "dragOverGapBottom", "isLeaf", "isStart", "isEnd", "expanded", "selected", "checked", "halfChecked", "loading", "domRef", "active", "data", "onMouseMove", "selectable"]; // @ts-ignore
  ...
  (0, _createClass2.default)(InternalTreeNode, [{
    ...
    function render() {
      ...
      return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({
        ...
        isStart: isStart,
        isEnd: isEnd
      }), this.renderDragHandler(), this.renderSwitcher(), this.renderSelector());
    }
  }]);
